      ...
      <div class="row">
        <div class="col-md-12 text-center text-dark" style="">
          ...
          <ul class="nav nav-pills">
            <li class="nav-item" style="" > <a href="" class="active nav-link" data-toggle="pill" data-target="#tabone">Upcoming</a> </li>
            <li class="nav-item text-primary"> <a class="nav-link text-primary" href="" data-toggle="pill" data-target="#tabtwo">History</a> </li>
          </ul>
          <div class="tab-content mt-2">
            ...
            <div class="tab-pane fade" id="tabtwo" role="tabpanel">
              <ul class="list-group">
                <li class="list-group-item d-flex justify-content-between align-items-center"> THE 1st DBee Music Festival </li>
                <li class="list-group-item d-flex justify-content-between align-items-center"> THE 3rd DBee Music Festival </li>
                <li class="list-group-item d-flex justify-content-between align-items-center"> THE 5th DBee Music Festival </li>
                <li class="list-group-item d-flex justify-content-between align-items-center"> THE 6th DBee Music Festival </li>
                <li class="list-group-item d-flex justify-content-between align-items-center"> THE 9th DBee Music Festival </li>
                <li class="list-group-item d-flex justify-content-between align-items-center" style=""> THE 19th DBee Music Festival </li>
                <li class="list-group-item d-flex justify-content-between align-items-center"> THE 20th DBee Music Festival </li>
                <li class="list-group-item d-flex justify-content-between align-items-center"> THE 21th DBee Music Festival </li>
              </ul>
            </div>
          </div>
        </div>
