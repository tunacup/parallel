...
<body >
  ...
  <div class="py-5">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12"><input type="email" class="form-control m-2 w-50" placeholder="Name"><input type="email" class="form-control m-2 w-50" placeholder="Surname"><input type="email" class="form-control m-2 w-50" placeholder="Email"><input type="email" class="form-control m-2 w-50" placeholder="Password" ></div>
      </div>
      <div class="row">
        <div class="col-md-12"><a class="btn m-3 btn-primary" href="#">Save Change</a></div>
      </div>
    </div>
  </div>
  <div class="py-3" >
