        ...
        <div class="mx-auto col-lg-12 col-10" style="">
          ...
          <form class="text-left">
            ...
            <div class="form-group"> 
				...
				<input type="text" class="form-control" id="form17" placeholder="081 234 5678"> 
			</div>
            <div class="form-row">
              <div class="form-group col-md-6"> 
              ...
              <div class="form-group col-md-6"> 
				...
				<input type="text" class="form-control" id="form20" placeholder="Confirm Email"> 
			  </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-6"> 
				<label for="form19">Password</label> 
				<input type="password" class="form-control" id="form19" placeholder="••••"> 
			  </div>
              <div class="form-group col-md-6"> 
				<label for="form20">Confirm Password</label> 
				<input type="password" class="form-control" id="form20" placeholder="••••"> 
			  </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-6"> 
				<label for="form19">Birthday</label> 
				<input type="date" class="form-control" id="form19" placeholder="••••"> 
			  </div>
            ...
            <div class="form-group">
              <div class="form-check"> 
				...
				<a class="btn btn-primary" href="concert_info.php">Sign up</a>
          </form>
        </div>
      </div>
    </div>
