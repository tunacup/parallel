 ...
 <div class="py-3 bg-warning">
  ...
  <div class="py-5">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12"><input type="text" class="form-control m-2 w-50" placeholder="Admin001"><input type="email" class="form-control m-2 w-50" placeholder="DBeeadmin001@gmail.com"><input type="email" class="form-control m-2 w-50" placeholder="**********"></div>
      </div>
    </div>
  </div>
