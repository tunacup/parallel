   ...
   <div class="py-5">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          <ul class="list-group">
            <li class="list-group-item d-flex justify-content-between align-items-center w-50 m-2">Zone A1 <span class="badge badge-primary badge-pill" style="">785/1000</span></li>
            <li class="list-group-item d-flex justify-content-between align-items-center w-50 m-2">Zone A2 <span class="badge badge-primary badge-pill" style="">811/1000</span></li>
            <li class="list-group-item d-flex justify-content-between align-items-center w-50 m-2">Zone B <span class="badge badge-primary badge-pill" style="">1592/2000</span></li>
            <li class="list-group-item d-flex justify-content-between align-items-center w-50 m-2">Zone C <span class="badge badge-primary badge-pill" style="">1794/2000</span></li>
          </ul>
        </div>
      </div>
    </div>
