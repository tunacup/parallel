    ...
    <div class="container">
      <div class="row">
        <div class="p-5 col-md-7 d-flex flex-column justify-content-center">
          ...
          <p class="mb-4 lead">Tel : 080-0000000<br>Email : DBeeMusic@gmail.com<br><br>Twitter : @DBeeMusic<br>Facebook : DBee Music Festival<br>Instagram : @DBeeMusic</p>
        </div>
        <div class="p-5 col-md-5">
          ...
          <form>
            ...
            <div class="form-group"> <label>Question</label> <input type="text" class="form-control w-100 h-25"> </div> <button type="submit" class="btn mt-4 btn-block btn-outline-dark p-2" href="sendq.php"><b>SEND</b></button>
          </form>
        </div>
      </div>
    </div>
